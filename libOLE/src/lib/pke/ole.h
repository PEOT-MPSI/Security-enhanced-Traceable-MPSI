...
namespace lbcrypto
{
    ...
    public:
        ...
        void send(osuCrypto::Channel &chl) const
        {
            chl.send(&numBlocks, sizeof(numBlocks));
        ...
        static VOLESenderInput<encoding_input_t> recv(osuCrypto::Channel &chl)
        {
            ui32 h64 = 0;
            chl.recv((u8 *)&h64, sizeof(h64));
            ui32 nB = static_cast<ui32>(h64);
    ...
    public:
        ...
        static VOLEReceiverOutput<encoding_input_t> receive(osuCrypto::Channel &chl)
        {

            ui32 h64 = 0;
            chl.recv((u8 *)&h64, sizeof(h64));
            ui32 blocks = static_cast<ui32>(h64);
    ...
    public:
            ...
            osuCrypto::Channel &chl)
        {
            ...
            ui32 h64 = 0;
            chl.recv((u8 *)&h64, sizeof(h64));
            ui32 numBlocks = static_cast<ui32>(h64);
    ...
    public:
        ...
        static BOLEReceiverInput<encoding_input_t> receive(osuCrypto::Channel &chl)
        {

            ui32 h64 = 0;
            chl.recv((u8 *)&h64, sizeof(h64));
            ui32 n = static_cast<ui32>(h64);
    ...
    public:
        ...
        void sendAll(osuCrypto::Channel &chl) const
        {
        ...
        static FourBOLEReceiverInputs<encoding_input_t> receiveAll(osuCrypto::Channel &chl)
        {
    ...
    public:
        ...
        static inline typename SchemeType::Ciphertext preprocessReceiverInput(
            ...
            const typename SchemeType::SecretKey &sk,
            const SchemeType &scheme) { return scheme.Encrypt(sk, input); }

        template <typename SchemeType>
        static inline typename SchemeType::SeededCiphertext preprocessReceiverInputSeeded(
            const typename SchemeType::encoding_input_t &input,
            const typename SchemeType::SecretKey &sk,
            const SchemeType &scheme) { return scheme.EncryptSeeded(sk, input); }
